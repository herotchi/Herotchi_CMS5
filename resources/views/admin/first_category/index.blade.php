<x-app-layout title="大カテゴリ一覧">
    ...
    <div class="card shadow mb-4">
        <form action="{{ route('admin.first_category.index') }}" method="GET" novalidate>
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <!-- タイトル -->
                    <div class="col-md-12">
                        <x-input-label for="name" value="大カテゴリ名" />
        ...
        <div class="card-body">
            <table class="table">
                ...
                @foreach ($lists as $list)
                    <tr>
                        <td scope="rol">
                            <a href="{{ route('admin.first_category.show', $list) }}">{{ $list->name }}</a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
