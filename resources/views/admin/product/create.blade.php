            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-12">
                        ...
                        <x-select-input name="second_category_id" :array="array()" :old="old('second_category_id')" />
                    ...
                    <div class="col-md-12">
                        ...
                        <x-text-area name="detail" :old="old('detail')" />
                        <x-input-error :message="$errors->first('detail')" />
                    </div>

                    <!-- 表示設定 -->
                    <x-input-label for="release_flg" value="表示設定" :required="true"/>
                    <x-radio-input name="release_flg" :array="$ProductConsts::RELEASE_FLG_LIST" :old="old('release_flg')" />
